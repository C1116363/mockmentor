 ...
 *
 * Deliberately NOT the same as MentorDto: there is no email and no user id here.
...
public record PublicMentorDto(
    ...
    public static PublicMentorDto from(MentorProfile profile) {
        return new PublicMentorDto(
