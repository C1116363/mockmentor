...
/** Scheduled, and not finished more than 2 hours ago. Soonest first. */
export function selectUpcoming(requests) {
  const cutoff = Date.now() - 2 * 60 * 60 * 1000;
  return requests
    .filter((r) => r.status === "SCHEDULED" && r.scheduledAt && new Date(r.scheduledAt) > cutoff)
